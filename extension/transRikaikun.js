...
var init = async () => {
    var addMenuButton = () => {
        var $btn = $(`<span class="menu-button buttonGroup group-rikai"><button class="button-rikai rikai hasMenuSide" data-tranattr="title" title="Enable Rikaikun (alt+r)" accesskey="r"><img src="${thisAddon.getWebLocation()}/images/icon48.png" alt="Rikaikun"></button><button class="button-find menuSide"></button></span>`)
